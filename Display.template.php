...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
      ...
      if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
		...
		echo '
					<div class="left_colum"><ul class="reset"> <!--Inicio Primera columna -->
                        <li class="avatar" style="overflow: auto;">
                           <a href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
      ...
      echo '          <div class="left_colum"> <!--Inicio segunda columna-->
		...
		if (!$message['member']['is_guest'])
		{
			...
			if (!empty($settings['show_blurb']) && $message['member']['blurb'] != '')
				echo '
				  ...
				  <div class="left_colum"> <!--Inicio segunda columna-->
		...
		echo '
            ...
            <div class="', $message['approved'] ? ($message['alternate'] == 0 ? 'windowbg' : 'windowbg2') : 'approvebg', '">
               ...
               <div class="post_wrapper">             
                  <div class="postarea" style="margin: 0 0 0 1.5em;">
		...
		echo '
						...
						<div class="moderatorbar" style="margin-left: 1.5em">
