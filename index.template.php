...
<head>';
	...
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/estadisticas.js"></script>
	...
	echo '
		...
		<div id="footer_section">
			<ul class="reset floatright" style="text-align: right;">
				<li class="copyright">', $context['forum_name'], ' &copy;</li>
				<li class="copyright">', GTA_cr(), '</li>
			</ul>
			<ul class="reset" style="text-align: left;">
...
// Theme Copyright GTA, PLEASE DO NOT REMOVE THIS!!
function GTA_cr()
{
	$GTA = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
	return $GTA;
}
