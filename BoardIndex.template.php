...
function template_info_center()
{
	...
	echo '
		...
		<div class="tb-boards" id="upshrinkHeaderIC"', empty($options['collapse_header_ic']) ? '' : ' style="display: none;"', '>';
	...
	// Statistics in jQuery.	
	   ...
	   <ul class="tabs">';
	   	...
	   	echo '
			<li><a href="#tab1">', $context['show_who'] ? '' : '', comma_format($context['num_guests']), ' ', $context['num_guests'] == 1 ? $txt['guest'] : $txt['guests'], ', ' . comma_format($context['num_users_online']), ' ', $context['num_users_online'] == 1 ? $txt['user'] : $txt['users'], '</a></li>';
	...
	{
		echo '
			<li><a href="#tab4">', $txt['recent_posts'], '</a></li>';
	} 
		echo '
	   </ul>';
	     
	   echo '
	   <div class="tab_container windowbg">';
	   
	   // "Users online" - in order of activity.
	echo '
		<div id="tab1" class="tab_content">
			<p class="inline stats">
				', $context['show_who'] ? '<a href="' . $scripturl . '?action=who' . '">' : '', '', $txt['who_title'], '', $context['show_who'] ? '</a>' : '', '';
